...
cd C:\projects\Docker\RdBrainsDockerDemo\src\RDBrainsDemo.ShoppingCart
...
docker run -d --name $DOCKER_CONTAINER_NAME --net $DOCKER_NETWORK_NAME $DOCKER_IMAGE_NAME
